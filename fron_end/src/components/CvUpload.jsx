          ...
          <div className="flex flex-col items-center justify-center gap-6">
            {!file && (
              <>
                <div className={`relative group`}>
                  <div className={`absolute inset-0 rounded-full bg-purple-400/20 group-hover:bg-purple-400/30 blur-xl transition-all duration-500 ${dragActive ? 'scale-150' : 'scale-100'}`}></div>
            ...
            {file && (
              <div className="w-full transform transition-all duration-500">
                ...
                {uploadStatus === 'error' && (
                  <div className="mt-6 text-center text-red-600 font-medium animate-fade-up">
                    Oups ! Veuillez sélectionner un fichier PDF valide 🙏
                  </div>
                )}
              </div>
            )}
